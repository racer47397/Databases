...
<html>
    ...
    <body>
        <ul class="section">
            ...
            <li><a class="active" href="info.jsp" class="navbar">Conócenos</a></li>
            <li><p class="navbar sesion" id="userP"><a href="index.html" class="navbar" id="cerrar" styles="display:block;">Cerrar sesión</a></p></li>
        </ul>
